...
public class MyRentDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_rent_details);
        ...
        location = findViewById(R.id.tvTownRent);
        ...
        btnCancelRent.setOnClickListener(v -> {
            new AlertDialog.Builder(context).setTitle("Annuler une location")
                    ...
                    .setPositiveButton("Oui", (dialog, which) -> {
                        ...
                        Call<ResponseBody> call = server.cancelRent(annoucedCars.getIdannounce());
    ...
    private void loadAnnounceData(AnnoucedCars annoucedCars) {
        ...
        callGetAnnounceInfo.enqueue(new Callback<AnnoucedCars>() {
            ...
            public void onFailure(Call<AnnoucedCars> call, Throwable t) {
                Toast.makeText(MyRentDetailsActivity.this, "Erreur de connexion au serveur", Toast.LENGTH_SHORT).show();
            }
        });
